This is the Github action for project [refactoring-cli](https://github.com/nbauma109/refactoring-cli). 

It's used to execute Eclipse Source Clean-Ups (equivalent of right-click menu `Source -> Clean Up`).

To raise a pull request with the suggested changes, configure a workflow file with all the desired cleanups:
  ...
  run-cleanup:
    ...
    steps:
      ...
      - name: Run refactoring action
        uses: nbauma109/refactoring-cleanup-action@v3
        with:
          project_root: .
          source_level: "21"
          ...
          cleanup_correct_indentation: true
          ...
          cleanup_merge_conditional_blocks: true
          cleanup_controlflow_merge: true
          cleanup_one_if_rather_than_duplicate_blocks_that_fall_through: false
          ...
          cleanup_add_missing_override_annotations_interface_methods: true
